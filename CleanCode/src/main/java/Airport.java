...
public class Airport {
    ...
    public Airport sortByMaxDistance() {
        Collections.sort(planes, new Comparator<Plane>() {
            public int compare(Plane firstMatchPlane, Plane secondMatchPlane) {
                return firstMatchPlane.getMaxFlightDistance() - secondMatchPlane.getMaxFlightDistance();
            }
        });
        return this;
    }
    ...
    public Airport sortByMaxSpeed() {
        Collections.sort(planes, new Comparator<Plane>() {
            public int compare(Plane firstMatchPlane, Plane secondMatchPlane) {
                return firstMatchPlane.getMS() - secondMatchPlane.getMS();
            }
        });
        return this;
    }
